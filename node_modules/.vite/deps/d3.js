...
function rotationIdentity(lambda, phi2) {
  return [abs3(lambda) > pi3 ? lambda + Math.round(-lambda / tau4) * tau4 : lambda, phi2];
}
...
function forwardRotationLambda(deltaLambda) {
  return function(lambda, phi2) {
    return lambda += deltaLambda, [lambda > pi3 ? lambda - tau4 : lambda < -pi3 ? lambda + tau4 : lambda, phi2];
  };
}
...
function circle_default2() {
  var center = constant_default6([0, 0]), radius = constant_default6(90), precision = constant_default6(6), ring, rotate, stream = { point: point2 };
  ...
  circle2.center = function(_) {
    return arguments.length ? (center = typeof _ === "function" ? _ : constant_default6([+_[0], +_[1]]), circle2) : center;
  };
  circle2.radius = function(_) {
    return arguments.length ? (radius = typeof _ === "function" ? _ : constant_default6(+_), circle2) : radius;
  };
  circle2.precision = function(_) {
    return arguments.length ? (precision = typeof _ === "function" ? _ : constant_default6(+_), circle2) : precision;
  };
  return circle2;
}
...
function circle_default3(radius) {
  var cr = cos2(radius), delta = 6 * radians, smallRadius = cr > 0, notHemisphere = abs3(cr) > epsilon4;
